...
description: "[12 June 2022] Word embeddings are powerful even when not accompanied by a neural network model. In this course project, we represent each Twitter user by word distribution or embeddings and use classical machine learning to do the classification task."
